...
const htmlTdAttributesTestCase = {
    testCaseName: 'HTML Attributes Test',
    testCaseType: 'boundary',
    testLogic: checkHtmlAttributes,
    extraParams: ['td', ['valign']]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, htmlTdAttributesTestCase.testCaseName, htmlTdAttributesTestCase.testCaseType, htmlTdAttributesTestCase.testLogic, htmlTdAttributesTestCase.extraParams);
}
